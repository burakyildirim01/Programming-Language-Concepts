...
(check-run
 ...
 (simple-switch "switch ( 5 )  case 5: 6 , case 3: 'burak' ,else 7" 6)
 (nested-switch "let x = 5 in let a = 0 in switch ( x ) case op(3,'sub',1) : 'comp301' , case 3: if zero?(a) then 10 else 11 , else let z = #false in let y = 12 in my-cond z then x , comp(x,'equal',5) then 'alkan' , else 'KU' " "'alkan'")
